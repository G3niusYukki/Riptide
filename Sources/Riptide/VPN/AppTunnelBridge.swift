...
// MARK: - Commands & Events (shared between AppTunnelBridge and TunnelProviderBridge)

/// Commands from the app to the tunnel extension.
...
/// Events from the tunnel extension to the app.
...
/// Errors from tunnel bridge operations.
